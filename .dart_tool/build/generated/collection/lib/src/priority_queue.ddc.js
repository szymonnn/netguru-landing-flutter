  ...
  src__priority_queue.HeapPriorityQueue$ = dart.generic(E => {
    ...
    class HeapPriorityQueue extends core.Object {
      ...
      [_grow]() {
        ...
        if (dart.notNull(newCapacity) < dart.notNull(src__priority_queue.HeapPriorityQueue._INITIAL_CAPACITY)) newCapacity = src__priority_queue.HeapPriorityQueue._INITIAL_CAPACITY;
    ...
    (HeapPriorityQueue.new = function(comparison) {
      ...
      this[_queue] = ListOfE().new(src__priority_queue.HeapPriorityQueue._INITIAL_CAPACITY);
      this[_length] = 0;
      this[comparison$] = (t0 = comparison, t0 == null ? src__utils.defaultCompare(E) : t0);
      ;
    ...
    HeapPriorityQueue[dart.implements] = () => [src__priority_queue.PriorityQueue$(E)];
